    ...
    <div className="bg-[#F7E7E6] py-14">
      <div className="w-11/12 mx-auto">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div>
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">01</p>
            ...
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">02</p>
              <p className="text-[#000000] font-semibold text-[24px]">
            ...
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">03</p>
              <p className="text-[#000000] font-semibold text-[24px]">
            ...
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">04</p>
              <p className="text-[#000000] font-semibold text-[24px]">
            ...
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">05</p>
              <p className="text-[#000000] font-semibold text-[24px]">
            ...
            <div className="mb-4">
              <p className="text-[#CC0000] text-[30px] font-extrabold">06</p>
              <p className="text-[#000000] font-semibold text-[24px]">
                CONSULTING SERVICES
              </p>
              <p className="text-base font-medium">
